...
import ru.diosespectro.gamevault.service.GamesStatistic;
...
public class SecurityController {
    ...
    public SecurityController(UserService userService, ActionLogService actionLogService, GamesStatistic gamesStatistic) {
    ...
    public String login(Model model, HttpServletRequest request) {
        model.addAttribute("pageTitle", "Войти в GameVault");
        model.addAttribute("currentUrl", request.getRequestURI());
        return "login";
    }
    ...
    public String showRegistrationForm(Model model, HttpServletRequest request){
        ...
        model.addAttribute("pageTitle", "Зарегистрироваться в GameVault");
        model.addAttribute("currentUrl", request.getRequestURI());
        return "register";
    }
    ...
    public ModelAndView roles(Model model){
        ...
        mav.addObject("roles", roleRepository.findAll());
        model.addAttribute("pageTitle", "Игры");
        return mav;
    }
    ...
    public String statisticCalculate(HttpServletRequest request,
                                     ...
                                     RedirectAttributes redirectAttributes) {
        redirectAttributes.addFlashAttribute("statistic", gamesStatistic.getStatistic(statOption));
